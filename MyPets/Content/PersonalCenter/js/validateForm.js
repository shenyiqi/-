...
//验证电话号码
function checktel() {
    tel = form1.yourphone.value;
    if (tel.length!=11) {
        divphonenumber.innerHTML = '<font class="tips_false">输入错误</font>';
    }
    else {
        divphonenumber.innerHTML = '<font class="tips_true">输入正确</font>';
    }
}
$()